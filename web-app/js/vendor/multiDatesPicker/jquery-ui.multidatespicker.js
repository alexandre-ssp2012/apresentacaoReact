			...
			init : function( options ) {
				...
				var mdp_events = {
					...
					onSelect : function(dateText, inst) {
                        ...
                        if ($this.datepicker('option', 'altField2') != undefined && $this.datepicker('option', 'altField2') != "") {
                            $($this.datepicker('option', 'altField2')).val(
                                $this.multiDatesPicker('getDates', 'string')
                            );
                        }
					},
                ...
                var altFieldOption2 = $this.datepicker('option', 'altField2');
                if (altFieldOption2) $(altFieldOption2).val($this.multiDatesPicker('getDates', 'string'));
			},
